# Rebuttal significance tests and per-seed results

For each reinforcement-learning benchmark, budget, and exact depth $L\in\{1,2,4\}$, we first select the configuration with the best observed mean episodic return. To test whether depth $L_a$ outperforms depth $L_b$, we use a one-sided Welch's $t$-test:

$$H_0: \mathbb{E}[Q_{L_a}] \leq \mathbb{E}[Q_{L_b}] \qquad\text{vs}\qquad H_1: \mathbb{E}[Q_{L_a}] > \mathbb{E}[Q_{L_b}].$$

The tests treat runs as independent and are reported without a multiple-comparison correction. Positive $\Delta Q$ favors the higher-depth configuration named first. Each seed entry below is the mean of the final five logged episodic returns. The reported mean and standard error are computed across those per-seed values.
...
### Table 5. Best $L=4$ versus all $L=2$ configurations in Sokoban
...
### Table 6. Best $L=2$ versus all $L=1$ configurations in Sokoban
...
### Table 7. Per-seed Sokoban small- and medium-budget fixed-compute results.
...
### Table 8. Per-seed Sokoban large-budget fixed-compute results.
...
### Table 9a. Per-seed Craftax small- and medium-budget fixed-compute results.

| Budget | $L$ | $E$ | $d$ | $s_1$ | $s_2$ | $s_3$ | $s_4$ | $s_5$ | $s_6$ | $s_7$ | $s_8$ | $s_9$ | Mean | SE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| small | 1 | 1 | 128 | 29.480 | 31.632 | 32.538 | 31.195 | 31.334 | 32.419 | 31.805 | 32.862 | 31.739 | 31.667 | 0.331 |
| small | 1 | 3 | 64 | 32.367 | 32.800 | 32.142 | 31.726 | 32.376 | 32.562 | 32.176 | 32.077 | 32.000 | 32.247 | 0.106 |
| small | 1 | 6 | 32 | 31.592 | 32.166 | 32.393 | 32.319 | 31.557 | 32.271 | 31.674 | 32.826 | 32.160 | 32.106 | 0.141 |
| small | 1 | 14 | 16 | 31.771 | 31.964 | 31.866 | 31.799 | 31.732 | 31.442 | 31.257 | 32.116 | 32.078 | 31.780 | 0.094 |
| small | 2 | 3 | 32 | 32.132 | 32.141 | 31.026 | 32.474 | 32.437 | 33.214 | 31.825 | 32.447 | 32.411 | 32.234 | 0.197 |
| small | 2 | 7 | 16 | 31.171 | 31.600 | 31.977 | 32.219 | 31.655 | 32.445 | 32.635 | 31.644 | 32.397 | 31.971 | 0.162 |
| small | 3 | 1 | 64 | 32.755 | 31.168 | 32.701 | 32.873 | 32.709 | 32.502 | 32.832 | 32.281 | 32.205 | 32.447 | 0.178 |
| small | 3 | 2 | 32 | 32.198 | 32.390 | 32.557 | 32.622 | 31.696 | 31.956 | 32.870 | 31.816 | 32.362 | 32.274 | 0.131 |
