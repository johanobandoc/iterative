...
\setcounter{figure}{1}
\begin{center}
  \includegraphics[width=0.98\textwidth]{recurrent_state_sokoban_fineweb.pdf}
\end{center}
\captionof{figure}{
...
\setcounter{figure}{3}
\begin{center}
  \includegraphics[width=0.98\textwidth]{fixed_compute_allocation_combined_toplegend.pdf}
\end{center}
\captionof{figure}{
...
\setcounter{figure}{4}
\begin{center}
  \includegraphics[width=0.92\textwidth]{fixed_compute_retained_improvement.pdf}
\end{center}
\captionof{figure}{
...
\setcounter{figure}{8}
\begin{center}
  \includegraphics[width=0.78\textwidth]{appendix_fixed_compute_budgets_equal_panels.pdf}
\end{center}
\captionof{figure}{
...
For each small and medium budget, the \(L=2\) configuration with the best observed mean return is compared with every \(L=1\) configuration. Positive \(\Delta Q\) favors \(L=2\), and \(p\) is from the one-sided Welch test defined above. \(n\) is the number of independent runs per configuration.
}
\begin{center}
\small
...
\begin{center}
  \includegraphics[width=0.98\textwidth]{language_model_recmoe_vs_gptmoe_budget16_2048.pdf}
\end{center}
\captionof{figure}{
...
\begin{center}
  \includegraphics[width=0.98\textwidth]{language_model_recmoe_vs_gptmoe_budget16_128.pdf}
\end{center}
\captionof{figure}{
...
\begin{center}
  \includegraphics[width=0.98\textwidth]{fineweb_small_medium_large_budget_sandwich_depthshared.pdf}
\end{center}
\captionof*{figure}{
